...
function SprintIntro({ subStep, nextSubStep }: SprintIntroProps) {
    ...
    >
      ...
      <div className="dialog">
        <p>
          ...
          <span className=" text-green-dark">每日站立會議（Daily Scrum）</span>{" "}
